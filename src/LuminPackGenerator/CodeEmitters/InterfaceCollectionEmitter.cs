...
public static class InterfaceEnumerableEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        ...
        sb.AppendLine("            {");
        sb.AppendLine("                ref var arrayIndex = ref writer.GetCurrentSpanOffset();");
        sb.AppendLine($"                if (!global::System.Runtime.CompilerServices.RuntimeHelpers.IsReferenceOrContainsReferences<{elementType}>())");
        sb.AppendLine("                {");
        sb.AppendLine("                    writer.EnsureAdditionalCapacity(checked(sizeof(int) + array.Length * global::System.Runtime.CompilerServices.Unsafe.SizeOf<" + elementType + ">()));");
        sb.AppendLine("                    writer.DangerousWriteUnmanagedArray(ref arrayIndex, array, out var arrayOffset);");
        sb.AppendLine("                    writer.Advance(arrayOffset);");
        sb.AppendLine("                    writer.CheckBuffer();");
        sb.AppendLine("                }");
        sb.AppendLine("                else");
        sb.AppendLine("                {");
        sb.AppendLine("                    writer.WriteCollectionHeader(ref arrayIndex, array.Length);");
        sb.AppendLine("                    writer.Advance(sizeof(int));");
        sb.AppendLine("                    foreach (ref var item in array.AsSpan())");
        sb.AppendLine("                    {");
        ...
        sb.AppendLine("            {");
        sb.AppendLine("                ref var listIndex = ref writer.GetCurrentSpanOffset();");
        ...
        sb.AppendLine("                    writer.DangerousWriteUnmanagedSpan(ref listIndex, span, out var spanOffset);");
        ...
        sb.AppendLine("                    {");
        sb.AppendLine("                        writer.WriteNullCollectionHeader(ref listIndex);");
        sb.AppendLine("                        writer.Advance(sizeof(int));");
        sb.AppendLine("                    }");
        sb.AppendLine("                    else");
        sb.AppendLine("                    {");
        sb.AppendLine("                        writer.WriteCollectionHeader(ref listIndex, span.Length);");
        sb.AppendLine("                        writer.Advance(sizeof(int));");
    ...
    public static void GenerateDeserializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        ...
        InterfaceCollectionEmitterHelper.AppendArrayDeserialize(sb, elementType);
    }
}

public static class InterfaceCollectionEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        var elementType = GetFirstGeneric(fieldData.TypeName);

        InterfaceCollectionEmitterHelper.AppendCollectionSerialize(sb, elementType);
    }
...
public static class InterfaceReadOnlyCollectionEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        var elementType = GetFirstGeneric(fieldData.TypeName);
...
public static class InterfaceListEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        var elementType = GetFirstGeneric(fieldData.TypeName);
    ...
    public static void GenerateDeserializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        ...
        sb.AppendLine("            }");
        sb.AppendLine("            reader.Advance(4);");
        sb.AppendLine("            var items = reader.CreateFreshListArray<" + elementType + ">(length, out var list);");
        sb.AppendLine("            ref var first = ref global::LuminPack.Code.LuminPackMarshal.DangerousGetArrayDataReference(items);");
...
public static class InterfaceReadOnlyListEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        var elementType = GetFirstGeneric(fieldData.TypeName);
...
public static class InterfaceDictionaryEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
...
public static class InterfaceReadOnlyDictionaryEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        var keyType = GetFirstGeneric(fieldData.TypeName);
...
public static class InterfaceLookupEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        var keyType = GetFirstGeneric(fieldData.TypeName);
...
public static class InterfaceGroupingEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        var keyType = GetFirstGeneric(fieldData.TypeName);
...
public static class InterfaceSetEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        var elementType = GetFirstGeneric(fieldData.TypeName);
...
public static class InterfaceReadOnlySetEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        var elementType = GetFirstGeneric(fieldData.TypeName);
...
internal static class InterfaceCollectionEmitterHelper
{
