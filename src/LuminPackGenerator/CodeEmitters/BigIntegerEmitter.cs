...
public static class BigIntegerEmitter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        ...
        sb.AppendLine("            global::System.Span<byte> temp = stackalloc byte[255];");
        sb.AppendLine("            if (value.TryWriteBytes(temp, out var written))");
        sb.AppendLine("            {");
        sb.AppendLine("                writer.WriteUnmanagedSpan(ref index, temp.Slice(0, written), out var offset);");
        sb.AppendLine("                ");
    ...
    public static void GenerateDeserializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        ...
        sb.AppendLine("            reader.Advance(4);");
        sb.AppendLine("            ");
        sb.AppendLine("            ref var src = ref reader.GetSpanReference(index);");
        sb.AppendLine("            value = new global::System.Numerics.BigInteger(global::System.Runtime.InteropServices.MemoryMarshal.CreateReadOnlySpan(ref src, length));");
        sb.AppendLine("            ");
