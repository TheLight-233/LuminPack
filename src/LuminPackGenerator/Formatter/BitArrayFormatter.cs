...
public static class BitArrayFormatter
{
    public static void GenerateSerializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        ...
        sb.AppendLine("            ref var view = ref global::LuminPack.Code.LuminPackMarshal.As<global::System.Collections.BitArray, global::LuminPack.Parsers.BitArrayView>(ref Unsafe.AsRef(in value));");
        sb.AppendLine("            ");
        sb.AppendLine("            writer.WriteCollectionHeader(ref index, view._bitLength);");
        sb.AppendLine("            ");
        sb.AppendLine("            writer.WriteUnmanagedArrayWithOutHeader(ref index, view._array, view._array.Length, out var offset);");
        sb.AppendLine("#else");
        sb.AppendLine("            ref var view = ref global::LuminPack.Code.LuminPackMarshal.As<global::System.Collections.BitArray, global::LuminPack.Parsers.BitArrayView>(ref Unsafe.AsRef(in value));");
        sb.AppendLine("            ");
    ...
    public static void GenerateDeserializeCode(LuminLocalFieldData fieldData, StringBuilder sb)
    {
        ...
        sb.AppendLine("            }");
        sb.AppendLine("            ");
        sb.AppendLine("            if (value is null || value.Count != length)");
        sb.AppendLine("            {");
        ...
        sb.AppendLine("            ");
        sb.AppendLine("#if NET10_0_OR_GREATER");
        sb.AppendLine("            ref var view = ref global::LuminPack.Code.LuminPackMarshal.As<global::System.Collections.BitArray, global::LuminPack.Parsers.BitArrayView>(ref value);");
        sb.AppendLine("            ");
        sb.AppendLine("            reader.ReadUnmanagedArray(ref index, ref view._array!, view._array.Length, out var offset);");
        sb.AppendLine("#else");
        sb.AppendLine("            ref var view = ref global::LuminPack.Code.LuminPackMarshal.As<global::System.Collections.BitArray, global::LuminPack.Parsers.BitArrayView>(ref value);");
        sb.AppendLine("            ");
