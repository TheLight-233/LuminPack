...
using static LuminPackUnitTest.PruneGenericWrapperTest;
...
namespace LuminPackUnitTest
{
    class Program
    {
        ...
        public static void RunCoreTests(List<string> results)
        {
            TestEmptyStruct(results);
            TestEnum(results);
            TestByte(results);
            TestSByte(results);
            TestShort(results);
            ...
            TestULong(results);
            TestString(results);
            TestStringNullAndEmpty(results);
            PhaseOneRegressionTest.Run(results);
            TestStringUtf8Token(results);
            TestStringUtf16(results);
            TestBool(results);
            TestDecimal(results);
            TestDouble(results);
            TestFloat(results);
            TestChar(results);
            TestDateTime(results);
            TestEnumArr(results);
            TestByteArr(results);
            TestSByteArr(results);
            TestShortArr(results);
            TestUShortArr(results);
            TestIntArr(results);
            TestUIntArr(results);
            TestLongArr(results);
            TestULongArr(results);
            TestStringArr(results);
            TestBoolArr(results);
            TestFloatArr(results);
            TestDoubleArr(results);
            TestCharArr(results);
            TestDateTimeArr(results);
            TestEnumList(results);
            TestByteList(results);
            TestSByteList(results);
            TestShortList(results);
            TestUShortList(results);
            TestIntList(results);
            TestUIntList(results);
            TestLongList(results);
            TestULongList(results);
            TestFloatList(results);
            TestDoubleList(results);
            TestDecimalList(results);
            TestCharList(results);
            TestStringList(results);
            TestBoolList(results);
            TestDateTimeList(results);
            TestByteIntDict(results);
            TestStringShortDict(results);
            TestStringStringDict(results);
            TestNullable(results);
            Test_HierarchicalBase(results);
            Test_HierarchicalSub1(results);
            Test_HierarchicalSub2(results);
            Test_SomeNestedPrivateEnum(results);
            Test_Move(results);
            Test_TestMethodCtor(results);
            Test_TestA(results);
            Test_TestB(results);
            Test_CursedGeneric(results);
            Test_PrivateNestedCollection(results);
            Test_ListElementClass(results);
            Test_ListElementClass2Renamed(results);
            Test_ProtectedShouldInclude(results);
            Test_ShouldIgnorePrivate(results);
            Test_Bindable(results);
            Test_TestPrivateMemberClass(results);
            Test_RecordWithPrivateMember(results);
            ...
            Test_StringData(results);
            Test_StringData2(results);
            Test_SaveData(results);
            Test_GenericStruct(results);
            Test_Generic(results);
            Test_ComplexGeneric(results);
            Test_ComplexGeneric2(results);
            Test_Sub1(results);
            Test_Sub3(results);
            Test_TestClass(results);
            Test_TestClass2(results);
            Test_TestClass3(results);
            Test_TestStruct(results);
            Test_TestStruct2(results);
            Test_SimpleClass(results);
            Test_SimpleRecordStruct(results);
            Test_SimpleRecordStruct2(results);
            Test_SimpleRecordStruct2_Generic(results);
            Test_SimpleRecord(results);
            Test_SimpleRecord2(results);
            Test_SimpleRecord3(results);
            Test_SimpleRecord4(results);
            Test_SimpleRecord5(results);
            Test_SimpleRecord6(results);
            Test_SimpleStruct(results);
            Test_SimpleClassWithConstructor(results);
            TestMultiThreadCodeGenSerialize(results);
            TestMultiThreadCodeGenDeserialize(results);
            TestMixedMultiThreadOperations(results);
            TestComplexDataSerialization(results);
            TestNestedDataSerialization(results);
            TestComplexDataWithNullValues(results);
            TestComplexDataWithEmptyCollections(results);
            TestVersionTolerantSerialization(results);
            TestSimpleReference(results);
            TestSimpleCircleReference(results);
            TestSimpleTree(results);
            TestComplexCircleReference(results);
            TestRingCircleReference(results);
            TestGenericIntSerialization(results);
            TestGenericClassSerialization(results);
            TestGenericDoubleSerialization(results);
            TestNestedGenericSerialization(results);
            TestGenericClass2Serialization(results);
            TestGenericPolymorphismWithString(results);
            TestGenericPolymorphismWithInt(results);
            TestNumericGenericPolymorphism(results);
            TestComplexGenericPolymorphism(results);
            TestTwoDimensionalArray(results);
            TestThreeDimensionalArray(results);
            TestFourDimensionalArray(results);
            TestFiveDimensionalArray(results);
            TestSixDimensionalArray(results);
            TestSevenDimensionalArray(results);
            TestAllArraysInOneContainer(results);
            TestLargeTwoDimensionalArray(results);
            TestUri(results);
            TestVersion(results);
            TestBigInteger(results);
            TestBitArray(results);
            //TestCultureInfo(results);
            TestTimeZoneInfo(results);
            TestType(results);
            TestStringBuilder(results);
            TestLazy(results);
            TestTuple(results);
            TestValueTuple(results);
            TestComplex(results);
            TestVector2(results);
            TestVector3(results);
            TestVector4(results);
            TestQuaternion(results);
            TestMatrix3x2(results);
            TestMatrix4x4(results);
            TestPlane(results);
#if NET8_0_OR_GREATER
            TestHalf(results);
            TestInt128(results);
            TestUInt128(results);
            TestDateOnly(results);
            TestTimeOnly(results);
            TestRune(results);
#endif
            TestConcurrentDictionary(results);
            TestSortedDictionary(results);
            TestStack(results);
            TestQueue(results);
            TestLinkedList(results);
            CollectionTypesSerializationTest.TestHashSet(results);
            TestSortedSet(results);
            TestSortedList(results);
            TestBlockingCollection(results);
            TestConcurrentBag(results);
            TestConcurrentQueue(results);
            TestConcurrentStack(results);
            TestCollection(results);
            TestObservableCollection(results);
            TestReadOnlyCollection(results);
            TestReadOnlyObservableCollection(results);
            TestPriorityQueue(results);
            TestImmutableArray(results);
            TestImmutableList(results);
            TestImmutableQueue(results);
            TestImmutableStack(results);
            TestImmutableDictionary(results);
            TestImmutableHashSet(results);
            TestImmutableSortedDictionary(results);
            TestImmutableSortedSet(results);
#if NET8_0_OR_GREATER
            TestFrozenDictionary(results);
            TestFrozenSet(results);
#endif
            TestIEnumerable(results);
            TestICollection(results);
            TestIReadOnlyCollection(results);
            TestIList(results);
            TestIReadOnlyList(results);
            TestIDictionary(results);
            TestIReadOnlyDictionary(results);
            TestILookup(results);
            TestIGrouping(results);
            TestISet(results);
            TestIReadOnlySet(results);
            TestIImmutableList(results);
            TestIImmutableQueue(results);
            TestIImmutableStack(results);
            TestIImmutableDictionary(results);
            TestIImmutableSet(results);
        }
...
StringSerializerFallbackTest.Run(testResults);
            ...
            ManualRegistrationTest.Run(testResults);
